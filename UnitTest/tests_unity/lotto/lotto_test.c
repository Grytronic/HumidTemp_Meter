...
static void update_5from50_testLOTTOresults_with_expected_value(uint8_t val)
{
...
static void update_2from12_testLOTTOresults_with_expected_value(uint8_t val)
{
...
static void set_5from50_testLOTTOresults_value(int val)
{
	for (uint8_t i = 0; i < 5; i++)
	{
		testLOTTOresults.lottoTab5from50[i] = val;
...
static void set_2from12_testLOTTOresults_value(int val)
{
	for (uint8_t i = 0; i < 2; i++)
	{
		testLOTTOresults.lottoTab2from12[i] = val;
...
static void set_generated_values_and_generate_LOTTO_numbers(int val)
{
	PERIPHERALS_set_value_for_generated_random_value(val);
	LOTTO_generate_numbers();
}

static void print_generated_numbers_5from50(uint8_t test_number)
{
	printf("\n\nTest_nr: %d \n", test_number);
...
static void print_generated_numbers_2from12(uint8_t test_number)
{
	printf("\n\nTest_nr: %d \n", test_number);
